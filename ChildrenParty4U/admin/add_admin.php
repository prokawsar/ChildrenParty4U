						...
						<div class="center-block col-md-6">
							<form class="form-auth-small" action="reg_comp.php" method="post">
								...
								<div class="form-group">
									...
									<input type="username" class="form-control" name="email" id="signup-email" placeholder="Email">
								</div>
								<div class="form-group">
									<label class="control-label sr-only">Username</label>
									<input type="text" class="form-control" id="country" name="username" placeholder="Username">
								</div>
								<div class="form-group">
