    ...
    <div class="page-content">
            ...
            <form action="book_ok.php" method="post">
             ...
             <?php
                ...
                <tr>  <td> Cost Per Child: </td><?php echo "<td><input type='hidden' value='".$CPC."' name='cpc'</input>".converti($CPC)."</td>"; ?></tr>
                <tr> <td> Total Child No: </td><?php echo "<td><input type='hidden' value='".$child_no."' name='child_no'</input>".$child_no."</td>"; ?></tr>
                <tr><td> Total Cost: </td> <?php echo "<td><input type='hidden' value='".$cost."' name='cost'</input>".converti($cost)."</td>"; ?></tr>
